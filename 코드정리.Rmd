...
# ga <- merge(garlic_production, weather2, by = cv) # 중복되는 곳
...
# garlic_production3 <- merge(garlic3, weather1, by = '일자') # 일자 기준으로 merge 하기 
...
##9 마늘 판매량에 영향을 주는것은 전년도 날씨 데이터라 생각하고 해보기
...
garlic_production <- cbind(garlic_production, month) # d3와 데이터를 합치기
